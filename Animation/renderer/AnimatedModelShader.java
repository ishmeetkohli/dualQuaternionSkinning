...
//	private static final MyFile VERTEX_SHADER = new MyFile("renderer", "animatedEntityVertex_LBS.glsl");
//	private static final MyFile VERTEX_SHADER = new MyFile("renderer", "animatedEntityVertex_DQS_fast.glsl");
	private static final MyFile VERTEX_SHADER = new MyFile("renderer", "animatedEntityVertex_DQS.glsl");
